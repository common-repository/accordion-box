									...
									<div id="postbox-container-2" class="postbox-container">
										<div id="advanced" class="meta-box-sortables">
											<div id="gallery_bank_get_started" class="postbox" >
												...
												<h2 class="hndle" style="text-align:center;font-size:30px;"><span>More Free Plugins Recommendation From Codelizar</span></h3>
												<div class="inside">
																										...
																										case "gallery-bank" :
																											?>
																												<a class="plugin-div-button install-now button" href="http://tech-banker.com/products/wp-gallery-bank/pricing/" target="_blank" >
																													<?php _e("Premium Editions", codelizar_accordion_shortcode_text_domain); ?>
																												</a>
																												<a class="plugin-div-button install-now button" href="http://tech-banker.com/products/wp-gallery-bank/" target="_blank" >
																													<?php _e("Visit Website", codelizar_accordion_shortcode_text_domain); ?>
																												</a>
																											<?php
																										break;
																										case "contact-bank" :
